...
static void* count_slice(void* data) {
    struct slice* const slice = (struct slice*) data;
...
static void insert(const char* str, ssize_t n) {
    ...
    if (str && n > 0) memcpy(&text[cursor], str, n);
    cursor += n;
    match();
}
    ...
    for (i = 1; i < argc; i++)        /* these options take no arguments */
        if (!strcmp(argv[i], "-v")) { /* prints version information */
            ...
            exit(0);
                       ...
                       argv[i], "-b")) /* appears at the bottom of the screen */
            topbar = 0;
        else if (!strcmp(
        ...
        /* these options take one argument */
            ...
            mon = atoi(argv[++i]);
                     ...
                     argv[i], "-p")) /* adds prompt to left of input field */
            prompt = argv[++i];
